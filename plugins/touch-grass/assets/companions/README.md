...
Bundled cat companions live in one directory per cat. Touch Grass ships with Nian and Yuzu, both based on the project's real-life model cats. Each pack contains all six required animations and is registered in `manifest.json`.
