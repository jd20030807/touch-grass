...
5. Ask Codex: `Open my Touch Grass settings and test the nap reminder.`
...
Then start a fresh session or run `/reload-plugins`. Review the plugin and hooks when prompted, then ask Claude: `Open my Touch Grass settings and test the nap reminder.`
